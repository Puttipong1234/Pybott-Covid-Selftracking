...
export default {
            ...
            return [
                {
                    ...
                    data: [this.sample.list_มีอาการไอ, this.sample.list_มีไข้, this.sample.list_เหนื่อยหอบ, this.sample.list_น้ำมูกไหล, this.sample.list_มีอาการเจ็บคอ]
                },
                {
                    label: "อาการของท่าน",
                    ...
                    data: [this.user.list_มีอาการไอ, this.user.list_มีไข้, this.user.list_เหนื่อยหอบ, this.user.list_น้ำมูกไหล, this.user.list_มีอาการเจ็บคอ]
                }
            ];
        },
        defaultOptions() {
    ...
    methods: {
        ...
        var url = `https://pybott-6th.herokuapp.com/api/get_user_report/`+this.userid
    axios
      .get(url)
      .then(response => {
      ...
      .then(response => {
        ...
        for (const property in response.data) {
            for (const each in response.data[property]) {
                ...
                list_มีอาการเจ็บคอ.push(response.data[property][each].มีอาการเจ็บคอ);
  }
}
